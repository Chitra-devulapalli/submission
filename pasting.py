...
t0 = cv2.imread("/home/chitra/Downloads/BaggageAI_CV_Hiring_Assignment (1) (1)/BaggageAI_CV_Hiring_Assignment/threat/0.jpg")
t1 = cv2.imread("/home/chitra/Downloads/BaggageAI_CV_Hiring_Assignment (1) (1)/BaggageAI_CV_Hiring_Assignment/threat/1.jpg")
t2 = cv2.imread("/home/chitra/Downloads/BaggageAI_CV_Hiring_Assignment (1) (1)/BaggageAI_CV_Hiring_Assignment/threat/2.jpg")
t3 = cv2.imread("/home/chitra/Downloads/BaggageAI_CV_Hiring_Assignment (1) (1)/BaggageAI_CV_Hiring_Assignment/threat/3.jpg")
t4 = cv2.imread("/home/chitra/Downloads/BaggageAI_CV_Hiring_Assignment (1) (1)/BaggageAI_CV_Hiring_Assignment/threat/4.jpg")
...
for i in range(5):
    ...
    bg[i][mask == 0] = [0, 0, 0]
    image = np.multiply(image, 0.7)
    pasted = bg[i]+image
    cv2.imwrite("/home/chitra/Downloads/BaggageAI_CV_Hiring_Assignment (1) (1)/BaggageAI_CV_Hiring_Assignment/pasted/"+"pasted"+str(i)+".jpg", pasted)
